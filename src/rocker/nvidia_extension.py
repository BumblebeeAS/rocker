...
class TRT(RockerExtension):
    ...
    @staticmethod
    def register_arguments(parser, defaults={}):
        parser.add_argument(name_to_argument(TRT.get_name()),
            action='store_true',
            default=defaults.get('trt', None),
            help="Install nvidia-tensorrt into the container")
